    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <section className="flex flex-col sm:flex-row gap-6 p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-sm text-gray-500 mt-1">{new Date(entity.releaseDate).getFullYear()}</p>
        </div>
      </section>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-500 pt-px">on {review.createdAt instanceof Timestamp ? review.createdAt.toDate().toLocaleDateString() : ''}</span>
            </div>
          </div>
        </div>
