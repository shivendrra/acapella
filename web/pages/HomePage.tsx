...
const SongListItem: React.FC<{ song: typeof newSongs[0] }> = ({ song }) => (
  <li className="flex items-center justify-between py-3 px-4 transition-colors odd:bg-transparent even:bg-black/[.03] dark:even:bg-white/[.03] hover:bg-black/[.05] dark:hover:bg-white/[.05]">
    <div>
