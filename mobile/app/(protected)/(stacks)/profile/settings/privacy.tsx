...
const PrivacySettings: React.FC = () => {
  ...
  return (
    <View style={[styles.root, { backgroundColor: c.bg }]}>
      <Text style={[styles.heading, { color: c.text }]}>Privacy</Text>
      <Text style={[styles.sub, { color: c.muted }]}>Control your privacy settings and who can see your activity.</Text>
      <View style={[styles.placeholder, { borderColor: c.border }]}>
        <Text style={{ color: c.muted }}>Privacy settings will be available here soon.</Text>
      </View>
    </View>
  );
};
